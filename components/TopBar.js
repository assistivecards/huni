...
export default class App extends React.Component {
  ...
  render(){
    return (
      <View style={{backgroundColor: this.props.backgroundColor ? this.props.backgroundColor : "#63b2b5"}}>
        <StatusBar backgroundColor={this.props.backgroundColor ? this.props.backgroundColor : "#63b2b5"} barStyle={this.props.backgroundColor == "#63b2b5" ? "light-content" : "dark-content"} />
        <SafeAreaView>
            ...
            {this.props.rightButtonRender &&
              <TouchableOpacity disabled={!this.props.rightButtonActive} onPress={() => this.onRightButtonPress()} style={{padding: 10, paddingHorizontal: 25}}>
                <View style={[styles.rightButton, {backgroundColor: "#fff", opacity: this.props.rightButtonActive ? 1: 0.4}]}>
                  ...
                  {!this.state.rightButtonActivity &&
                    <Svg width={25} height={25} viewBox="0 0 25 25" strokeWidth={1} stroke={"#63b2b5"}>
                      <Path fill={"#63b2b5"} d="M9 16.2l-3.5-3.5c-.39-.39-1.01-.39-1.4 0-.39.39-.39 1.01 0 1.4l4.19 4.19c.39.39 1.02.39 1.41 0L20.3 7.7c.39-.39.39-1.01 0-1.4-.39-.39-1.01-.39-1.4 0L9 16.2z"></Path>
                    </Svg>
                  }
                </View>
              </TouchableOpacity>
